...
// 				return '<img src="' + data.data[0].images.low_resolution.url + '"></p><p>' + data.data[0].caption.text + ' <small><em>' + prettyDate(date.toString("yyyy-MM-ddTHH:mm:ssZ")) + '</em></small>';
// 			},
// 			delay: { show: 0, hide: 0 }
// 		});
// 	});
...
// 				return '<img src="' + episode.episode_poster_url + '" style="text-align:center;width:100%"></p><p><strong>' + episode.media_title + '</strong> ' + episode.episode_label + ' <em>' + episode.episode_title + '</em> <small><em>' + prettyDate(episode.created_at) + '</em></small>';
// 			}
// 		});
// 	});
...
// 				}
// 				return '<span style="clear:left;">' + image + '<strong>' + track.artist['#text'] + '</strong> - ' + track.name + '<br><small><em>' + prettyDate(date.toString('yyyy-MM-ddTHH:mm:ssZ')) + '</em></small></span>';
// 			}
// 		});
// 	});
