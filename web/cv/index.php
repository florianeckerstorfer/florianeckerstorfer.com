	...
	<div class="row">
		<div class="span8">
			...
			<ul class="cv-list">
				...
				<li><em>Matura</em>, <strong>HLW f&uuml;r Kommunikations- und Mediendesign</strong><br>
			...
			<ul class="cv-list">
				...
				<li>
					<em>Internship</em>, <strong>Strobl)Kriegner Group</strong>, Linz, AT, August 2004
					<ul>
						<li>Web Design</li>
						<li>Print Design</li>
				...
				<li>
					<em>Internship</em>, <strong>CREATEAM Werbeagentur GmbH</strong>, Linz, AT, June - July 2004
					<ul>
						<li>Web Design</li>
						<li>Print Design</li>
						<li>Frontend Development</li>
				...
				<li>
					<em>Internship</em>, <strong>CREATEAM Werbeagentur GmbH</strong>, Linz, AT, August 2003
					<ul>
						<li>Web Design</li>
						<li>Print Design</li>
						<li>Frontend Development</li>
			...
			<ul class="cv-list">
				...
				<li>
					<a href="http://symfony.com"><strong>Symfony2 Forms Framework</strong></a><br>
					A framework to create, validate and submit forms. Part of the Symfony2 Framework.
				</li>
			</ul>
